<script lang="ts">
  ...
  function handleClick(event: MouseEvent) {
    ...
    if (clickedCellsCount === userInput * 3) {
...
<p>
  You have played {clickedCellsCount} of {userInput * 3} shots, so you have
  {userInput * 3 - clickedCellsCount} shots left.
</p>
