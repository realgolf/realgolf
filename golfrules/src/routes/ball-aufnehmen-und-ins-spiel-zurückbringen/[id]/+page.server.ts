...
const posts_record = import.meta.glob('/src/data/ball-aufnehmen-und-ins-spiel-zurückbringen/*.md', {
	as: 'raw',
	eager: true
});
...
export const load = async (event: { params: { id: any } }) => {
	...
	const path = `/src/data/ball-aufnehmen-und-ins-spiel-zurückbringen/${id}.md`;
