...
const posts_record = import.meta.glob(
	'/src/data/vorgehensweise-für-die-spieler-und-die-spielleitung-bei-strittigen-fällen-der-regelanwendung/*.md',
	{
		as: 'raw',
		eager: true
	}
...
export const load = async (event: { params: { id: any } }) => {
	...
	const path = `/src/data/vorgehensweise-für-die-spieler-und-die-spielleitung-bei-strittigen-fällen-der-regelanwendung/${id}.md`;
